            ...
            <RootStyle {...varSidebar}>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Mod</Typography>
                    <SettingMode />
                  </Stack>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Yön</Typography>
                    <SettingDirection />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Düzen</Typography>
                    <SettingLayout />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Ön Ayarlar</Typography>
                    <SettingColorPresets />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">Esnet</Typography>
                    <SettingStretch />
                  </Stack>
